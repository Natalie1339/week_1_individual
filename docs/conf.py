#
# practice-ntruesde documentation build configuration file
#
import os
import sys
...
# built documents.
try:
    version = importlib.metadata.version("practice_ntruesde")
...
htmlhelp_basename = "practice-ntruesde_doc"
